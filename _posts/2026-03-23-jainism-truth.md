...
Beyond blaming others, we also distort our own self-image. Carl Rogers conceptualized three different versions of our "self": the **real self**, the **imagined self**, and **ideal self**. The real self is who we actually are and the imagined self is who we think we are. The ideal self is who we aspire to be. According to Rogers, the goal of personal development is **Congruence** which happens when our imagined self aligns with our real self, and both are moving toward a realistic ideal self.

When we act in a way that is inconsistent with our ideal self, we either *distort the truth* so it fits our imagined self or we completely *deny the truth*, blocking it out from our consciousness. For example, a person who doesn't let her partner meet his friends distorts the truth by telling herself that she is doing it because her ex was not trustworthy, even if her current partner has done nothing to warrant such behavior and insecurity is the real reason behind her behavior.
